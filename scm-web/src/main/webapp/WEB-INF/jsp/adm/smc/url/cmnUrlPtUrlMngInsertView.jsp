...
<script type="text/javascript">
    ...
    function updateProgramPermission() {
        ...
        const rprsPrgrmYnCheckbox = document.querySelector('input[type="checkbox"][value="1"]');
    ...
    function validateForm() {
        const requiredFields = [
            'prgNm', 'urlAddr', 'prgrmRsltTypeNm', 'prgrmClsfCd', 'dvlprNm', 'prgrmExpln'
        ];
    ...
    function submit() {
        if (validateForm()) {
            ...
            const serviceUrl = "/adm/smc/url/insertCmnUrlPtUrlMngDetail.json";
            sendJson(serviceUrl, params, function (data) {
                if (data.result) {
                    ...
                    if (data.duplicate) {
                        // URL 중복 에러 처리
                        alert(data.message + " 중복된 URL: " + data.urladdr);
                    } else {
                        // 기타 실패 메시지
                        alert(data.message);
                    }
...
<div class="category-wrapper">
    <ul class="page-category">
        ...
        <li class="category-item"><a href="#">URL 등록</a></li>
    </ul>
</div>
<!-- 카테고리 끝 -->

<!-- 페이지 타이틀 시작 -->
<h1 class="page-title-1depth"><span>URL 등록</span></h1>
<!-- 페이지 타이틀 끝 -->
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <input type="text" id="prgNm" class="form-control" placeholder="" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <input type="text" id="urlAddr" class="form-control" placeholder="" style="width:100%;">
                    </td>
                </tr>
                <tr>
                        ...
                        <div class="mt-checkbox-inline">
                            <label class="checkbox-label-group">프로그램 권한 선택 <!-- Checkbox들을 그룹으로 묶을 때 Label을 그룹으로 감싼다 -->
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" value="1"> 조회
                                    <span></span>
                                </label>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="mdfcnAuthrtYn"> 수정
                                    <span></span>
                                </label>
                            </label>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="dvlprNm" class="form-control" placeholder="" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <textarea id="prgrmExpln" class="form-control" maxlength="300" oninput="updateByteCount();" style="resize: none;" placeholder="설명을 입력하세요..."></textarea>
