<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/common/js/file.js"></script>
		...
		============================================================== -->
        <!-- 레이아웃 CSS -->
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/com/css/front.css">
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/com/css/management.css"><!-- !!! 필독 : 관리자화면들은 "management.css"를 추가 -->
