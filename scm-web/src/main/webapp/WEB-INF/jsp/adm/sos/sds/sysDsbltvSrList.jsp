...
<script>
	...
	const submitForm = {
		search: function(pageNo){
			...
			const url = '/adm/sos/sds/selectSysDsbltvSrList.json';
		...
		, renderTable: function(list){
			...
			if(!list){
				srList.innerHTML = '<tr><td colspan="4">조회된 데이터가 없습니다.</td></tr>';
				return;
			}
			
			const columns = ['rowNum', 'sysSrvcDmndTtl', 'frstRgtrId', 'frstRegDt', 'inqCnt']
			list.forEach((data) => {
				...
				tr.addEventListener('click', (e) => {
					params.sysSrvcDmndSn = data.sysSrvcDmndSn;
					
					sendForm('/adm/sos/sds/sysDsbltvSrDetail.do', params);
				});
	...
	<!-- 페이지 타이틀 시작 -->
	<h1 class="page-title-1depth"><span>시스템 장애 신고 관리 목록</span></h1>
	<!-- 페이지 타이틀 끝 -->
				...
				<div class="form-inline row">
					<div class="input-group col-lg-3 col-md-3 col-sm-3 col-xs-3">
						...
						<select id="srchCondition" class="form-control">
							...
							<option value="sysSrvcDmndTtl">제목</option>
							<option value="sysSrvcDmndCn">내용</option>
						</select>
					</div>
