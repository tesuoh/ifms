...
<div class="content-wrap active">
	<div class="breadcrumb-wrap">
		...
		<span class="breadcrumb">홈 > <spring:message code="label.mlng.mng" /></span>
	</div>
	<form id="searchForm">
				...
				<div class="form-box">
					<div class="form-box">
						<div class="form-row">
							...
							<div class="from-item">
								<div class="input-box">
									<input type="text" id="inp5" name="inp1" maxlength=40
										placeholder="" class="ev-input-text-box">
									<button type="button" class="btn-clear ev-click-btn-clear"
										style="display: none;">
										<span class="sr-only">${delInpText}</span>
					...
					<div class="form-box">
						<div class="form-row">
							...
							<div class="from-item">
								<div class="input-box">
									<input type="text" id="inp7" name="inp1" maxlength=40
										placeholder="" class="ev-input-text-box">
									<button type="button" class="btn-clear ev-click-btn-clear"
										style="display: none;">
										<span class="sr-only">${delInpText}</span>
...
<script type="text/javascript">
	...
	async function _initScreen() {
		...
		const coneInfo = [
			{ bindType : "div", comCodeId : "CD0001", compId : "code4" : includeAll : true},
		]
		
		CmnCode.bindCmnCodes(condeInfo, document);
